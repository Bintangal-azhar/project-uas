...
<body>
	<nav class="navbar navbar-inverse" style="margin-bottom: 0px;">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#">Bintang<strong>Showroom</strong></a>
		</div>
		<div id="mySidenav" class="sidenav">
			...
			<li><a href="shop.php">  <span class="glyphicon glyphicon-cart"></span>Shop</a></li>
			<li><a href="contact.php">  <span class="glyphicon glyphicon-cart"></span>contact</a></li>
